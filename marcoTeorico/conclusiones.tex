...
La decisión de usar PyEcore~\cite{pyecore_pyecore_2020} es porque es la única opción viable de integrar las transformaciones modelo a modelo y las definiciones de las gramáticas creadas por De la Vega~\cite{de_la_vega_mortadelo_2020}.
