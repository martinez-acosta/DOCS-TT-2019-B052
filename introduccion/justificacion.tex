...
Actualmente, las pocas herramientas para modelado conceptual NoSQL no ofrecen validaciones para sus diagramas ni dan la posiblidad de obtener el esquema SQL, ya que no están enfocados en sistemas relacionales, sino en un modelo lógico y físico específico para cada tipo de sistema NSQL (clave-valor, orientado a documentos, columnas o grafos).
