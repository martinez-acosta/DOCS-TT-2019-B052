...
Asimismo, los \textit{scripts} generados se probarán con MySQL porque es el DBMS que se usa en la asignatura de Base de Datos y es con el que están más familiarizados los estudiantes.
