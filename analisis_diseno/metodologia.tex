...
\begin{itemize}
	\item Desarrollo adaptativo de \textit{software} (DAS).
	\item Scrum.
...
De acuerdo con Scrum México\cite{scrum_mexico_scrum_2020}, las historias de usuario es la técnica por la que el usuario especifica de manera general los requerimientos que el sistema debe cumplir.


Normalmente estas redacciones se llevan a cabo en tarjetas de papel donde se describen brevemente las funciones que el producto final debe poseer, ya sean requisitos fucionales o no.
...
\begin{itemize}
	\item N.° 6
	\item Como usuario me gustaría poder ver el último trabajo que realicé
...
Se considera la siguiente lista como la lista de producto con las tareas necesarias para cumplir con todas las historias de usuario mencionadas en la sección anterior, considerando que es posible que cambien conforme avancen los \textit{sprints} y así añadir nuevas tareas.
...
\begin{longtable}{ p{2cm} | p{10cm} | p{2cm} }
	...
	\hline
	\centering 13 & Ajustar la interfaz del menú ER para mostrar mensaje de tranformación al modelo NoSQL. & Omar \\[0.5cm]
	\hline
