...
Considerado a 2 personas en el equipo de desarrollo y un periodo de 9 meses(se agrego un mes más para el caso de estudio) y utilizando los salarios de la tabla~\ref{tab:devs_salary}, tenemos que los gastos totales se obtienen con la siguiente fórmula:
